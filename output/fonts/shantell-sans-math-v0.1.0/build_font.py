...
def build(source: Path, artwork: Path, output: Path):
    ...
    replacement = {
        1: 'Shantell Sans Math Medium', 2: 'Regular',
        3: '0.100;Whitespace;ShantellSansMath-Medium',
        4: 'Shantell Sans Math Medium', 5: 'Version 0.100',
        6: 'ShantellSansMath-Medium',
        ...
        16: 'Shantell Sans Math', 17: 'Medium',
        18: 'Shantell Sans Math Medium', 21: 'Shantell Sans Math', 22: 'Medium',
        25: 'ShantellSansMath',
    }
    ...
    (output / 'shantell-sans-math-metrics.json').write_text(json.dumps(metrics, indent=2) + '\n')
    shutil.copyfile(artwork / 'OFL.txt', output / 'OFL.txt')
    (output / 'build-info.json').write_text(json.dumps({
        'family': 'Shantell Sans Math', 'style': 'Medium', 'weight': 500,
