...
- Every element has a unique stable id and optional plain-text label. Labels are literal text; do not supply LaTeX or combining accents (v⃗). Write v or v →. Coordinates are [x, y] in mathematical units, never pixels.
