...
- demonstration: Your visual whiteboard for showing an idea rather than only describing it. Use it when seeing a concept makes it clearer than words alone, such as a diagram, a process, a transformation, a spatial relationship, or how something changes over time. The clip plays alongside your written response, so let your text carry the explanation while the demonstration carries the visual. Set instruction to a complete, self-contained brief: the concept being shown, what appears on screen, and the motion or sequence over time. Describe the demonstration you have planned, not the learner's raw wording. Skip it for purely textual ideas or when a static description is already enough.
